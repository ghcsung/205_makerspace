...
query = df_raw.repartition(1).writeStream.foreachBatch(foreach_batch_function).format("csv").option("header", "true").option("checkpointLocation", "checkpoint_final").option("path", "output_final").outputMode("append").start()
